                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <BreezeNavLink :href="route('accounts.index')" :active="route().current('accounts.index')">
                                    Accounts
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('contacts.index')" :active="route().current('contacts.index')">
                                    Contacts
                                </BreezeNavLink>
                            </div>
                        </div>
